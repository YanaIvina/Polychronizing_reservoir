...
#include "triangular_stdp_module.h"

#include "stdp_paugam_moisy.h"
...
triangular_stdp_module triangular_stdp_module_LTX_mod;
#endif

// -- DynModule functions ------------------------------------------------------

triangular_stdp_module::triangular_stdp_module()
{
#ifdef LINKED_MODULE
...
const std::string
triangular_stdp_module::name(void) const
{
  return std::string("triangular_stdp_module"); // Return name of the module
}

//-------------------------------------------------------------------------------------
void
triangular_stdp_module::init( SLIInterpreter* i )
{
  
  nest::register_connection_model< nest::stdp_paugam_noisy_synapse >( "stdp_paugam_moisy_synapse" );
  

} // triangular_stdp_module::init()